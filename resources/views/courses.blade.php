<x-layout>
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 mt-20 mb-10 mx-20">
      <a href="#course1" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-2xl text-xl">Time Management</a>
      <a href="#course2" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-2xl text-xl">Effective Communication</a>
      <a href="#course3" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-2xl text-xl">Stress Management</a>
      <a href="#course4" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-2xl text-xl">Problem Solving</a>
      <a href="#course5" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-2xl text-xl">Decision Making</a>
      <a href="#course6" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-2xl text-xl">Leadership Skills</a>
      <a href="#course7" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-2xl text-xl">Emotional Intelligence</a>
      <a href="#course8" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-2xl text-xl">Adaptability</a>
      <a href="#course9" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-2xl text-xl">Creativity</a>
