<x-layout>
  ...
  <div class="relative bg-darkblue text-white min-h-screen flex flex-col items-center justify-center font-pop bg-gradient-to-t from-black to-transparent bg-opacity-60">
    ...
    <div class="container my-16 mx-auto px-10 md:p-20 z-10 sm:backdrop-blur-sm rounded-xl sm:border border-white contrast-150 text-cente drop-shadow-xl">
      <h1 class="text-2xl sm:text-3xl md:text-4xl lg:text-4xl font-bold leading-tight mb-4 ">East African Professional Counselling Institute (EAPCI)</h1>
  ...
  <div class="relative bg-bgwhite py-16">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <h3 class="text-2xl font-bold text-gray-700 mb-2 font-serif">Extensive Service Offerings</h3>  <p class="text-gray-700 text-lg leading-relaxed mb-8">
      ...
      <h3 class="text-2xl font-bold text-gray-700 mb-2 font-serif">Our Impact</h3>  <p class="text-gray-700 text-lg leading-relaxed mb-8">
      ...
      <h3 class="text-2xl font-bold text-gray-700 mb-2 font-serif">Vision and Mission</h3>  <p class="text-gray-700 text-lg leading-relaxed mb-8">
  ...
  <div class="bg-gray-100 py-16">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-8">
      <div class="border border-gray-200 rounded-lg p-4 shadow-md">
        <h3 class="text-xl font-bold text-gray-800 mb-4">EAPCI Niche</h3>
        ...
        <div class="bg-indigo-50 border border-gray-200 rounded-lg p-8 shadow-md">
