<x-layout>
  ...
  <div class="relative bg-bgwhite p-10 md:p20 text-justify font-pop">
    <div class="container mx-auto">
      ...
      <h3 class="text-3xl  text-center md:text-left text-black p-3 my-5  font-yesava w-full border-b-2 border-black">Extensive Service Offerings</h3>  <p class="text-gray-700 text-lg leading-relaxed mb-8">
      ...
      <h3 class="text-3xl  text-center md:text-left text-black p-3 my-5  font-yesava w-full border-b-2 border-black">Our Impact</h3>  <p class="text-gray-700 text-lg leading-relaxed mb-8">
      ...
      <h3 class="text-3xl  text-center md:text-left text-black p-3 my-5  font-yesava w-full border-b-2 border-black">Vision and Mission</h3>  <p class="text-gray-700 text-lg leading-relaxed mb-8">
  ...
  <div class="p-10 md:p-20 bg-gradient-to-t from-darkblue to-bgwhite text-justify">
    <div class="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
      <div class=" rounded-lg p-5 shadow-2xl text-bgwhite bg-darkblue hover:shadow-[3px_3px_7px_#2C6173] transition duration-300 ease-in-out">
        ...
        <div class="bg-bgwhite border border-gray-200 rounded-lg p-8 shadow-2xl hover:shadow-[3px_3px_7px_#2C6173] transition duration-300 ease-in-out">
