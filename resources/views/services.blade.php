...
{{-- mainend --}}
      ...
      <div class="w-full bg-bgwhite px-10 md:px-20 py-20 font-pop ">
        <h2 class="text-2xl font-bold text-center text-gray-800 mb-4 font-yesava">Step Forward For A Well-being Journey: Service Descriptions</h2>
        <ul class="service-list grid grid-cols-1 md:grid-cols-2 gap-4">
          <li class="service-item py-4 px-6 rounded-lg shadow-inner hover:shadow-[5px_5px_10px_#e1fcff,-5px_-5px_10px_#cbe4ec] transition duration-300 ease-in-out">
            <h3 class="text-xl font-bold text-gray-800 mb-2 font-yesava">1. Stress, Anxiety, and Depression Counseling</h3>
          ...
          <li class="service-item py-4 px-6 rounded-lg shadow-inner hover:shadow-[5px_5px_10px_#e1fcff,-5px_-5px_10px_#cbe4ec] transition duration-300 ease-in-out">
            <h3 class="text-xl font-bold text-gray-800 mb-2 font-yesava">2. Child, Youth, and Adult Counseling</h3>
            <p class="text-gray-700">
          ...
          <li class="service-item py-4 px-6 rounded-lg shadow-inner hover:shadow-[5px_5px_10px_#e1fcff,-5px_-5px_10px_#cbe4ec] transition duration-300 ease-in-out">
            <h3 class="text-xl font-bold text-gray-800 mb-2 font-yesava">3. Psychological Assessment and Psychotherapy</h3>
            <p class="text-gray-700">
        ...
        <li class="service-item py-4 px-6 rounded-lg shadow-inner hover:shadow-[5px_5px_10px_#e1fcff,-5px_-5px_10px_#cbe4ec] transition duration-300 ease-in-out">
            <h3 class="text-xl font-bold text-gray-800 mb-2 font-yesava">4. Alcohol, Drug Abuse, and Addiction Counseling</h3>
            <p class="text-gray-700">
        ...
        <li class="service-item py-4 px-6 rounded-lg shadow-inner hover:shadow-[5px_5px_10px_#e1fcff,-5px_-5px_10px_#cbe4ec] transition duration-300 ease-in-out">
          <h3 class="text-xl font-bold text-gray-800 mb-2 font-yesava" >5. Loss, Grief, and Trauma Counseling</h3>
          <p class="text-gray-700">
      ...
      <li class="service-item py-4 px-6 rounded-lg shadow-inner hover:shadow-[5px_5px_10px_#e1fcff,-5px_-5px_10px_#cbe4ec] transition duration-300 ease-in-out">
          <h3 class="text-xl font-bold text-gray-800 mb-2 font-yesava">6. Gender Identity and Sexuality Counseling</h3>
          <p class="text-gray-700">
      ...
      <li class="service-item py-4 px-6 rounded-lg shadow-inner hover:shadow-[5px_5px_10px_#e1fcff,-5px_-5px_10px_#cbe4ec] transition duration-300 ease-in-out">
          <h3 class="text-xl font-bold text-gray-800 mb-2 font-yesava">7. Career and Financial Guidance</h3>
          <p class="text-gray-700">
      ...
      <!-- 8. Life Coaching -->
      <li class="service-item py-4 px-6 rounded-lg shadow-inner hover:shadow-[5px_5px_10px_#e1fcff,-5px_-5px_10px_#cbe4ec] transition duration-300 ease-in-out">
          <h3 class="text-xl font-bold text-gray-800 mb-2 font-yesava">8. Life Coaching</h3>
          <p class="text-gray-700">
      ...
      <li class="service-item py-4 px-6 rounded-lg shadow-inner hover:shadow-[5px_5px_10px_#e1fcff,-5px_-5px_10px_#cbe4ec] transition duration-300 ease-in-out">
          <h3 class="text-xl font-bold text-gray-800 mb-2 font-yesava">9. HIV/AIDS Counseling</h3>
          <p class="text-gray-700">
      ...
      <li class="service-item py-4 px-6 rounded-lg shadow-inner hover:shadow-[5px_5px_10px_#e1fcff,-5px_-5px_10px_#cbe4ec] transition duration-300 ease-in-out">
          <h3 class="text-xl font-bold text-gray-800 mb-2 font-yesava">10. Premarital, Marriage, and Family Counseling</h3>
          <p class="text-gray-700">
      ...
      <li class="service-item py-4 px-6 rounded-lg shadow-inner hover:shadow-[5px_5px_10px_#e1fcff,-5px_-5px_10px_#cbe4ec] transition duration-300 ease-in-out">
          <h3 class="text-xl font-bold text-gray-800 mb-2 font-yesava">11. Psychospiritual Therapy</h3>
          <p class="text-gray-700">
